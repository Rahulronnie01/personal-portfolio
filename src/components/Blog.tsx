...
{
title: "50M+ Reel Views Generated",
excerpt: "Helped multiple D2C brands reach millions through optimized reel hooks, storytelling formats, and distribution strategies.",
...
{
title: "120% Engagement Growth",
excerpt: "Improved engagement across brand pages by restructuring content pillars, audience-first storytelling, and consistent reel distribution.",
category: "Engagement",
readTime: "Strategy",
color: "from-purple-500 to-pink-500",
link: "/case-study/engagement-growth",
},
{
title: "3X Campaign Sales Boost",
excerpt: "Designed high-converting content campaigns that turned Instagram engagement into direct product sales for D2C brands.",
category: "Campaign",
readTime: "Case Study",
color: "from-orange-500 to-red-500",
link: "/case-study/sales-campaign",
},
];
         ...
         {INSIGHTS.map((insight, index) => (
            ...
            >
                <div className="h-full bg-white/5 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm hover:bg-white/10 transition-colors flex flex-col">
                    {/* Header Gradient */}
                    <div className={`h-2 bg-linear-to-r ${insight.color}`} />
